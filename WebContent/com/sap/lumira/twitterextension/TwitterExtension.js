...
define(["service!sap.bi.da.extension.sdk.clientRequestService", "TwitterExtensionDialogController"], function (ClientRequestService, TwitterExtensionDialogController) {
    "use strict";

    function TwitterExtension() {

        var EXTENSION_ID = "com.sap.lumira.twitterextension";
        ...
        var createTwitterExtensionDialog = function(acquisitionState, workflow) {
            var oDeferred = new jQuery.Deferred();
            var controller = new TwitterExtensionDialogController(acquisitionState, oDeferred, fServiceCall, workflow);
        ...
        this.doCreateWorkflow = function(acquisitionState) {
            return createTwitterExtensionDialog(acquisitionState, "CREATE");
        };

    	// This function will be called during an edit dataset workflow
        this.doEditWorkflow = function(acquisitionState) {
            return createTwitterExtensionDialog(acquisitionState, "EDIT");
        };
        ...
        this.doRefreshWithPromptWorkflow = function(acquisitionState) {
            return createTwitterExtensionDialog(acquisitionState, "REFRESH_WITH_PROMPTS");
        };
    }
